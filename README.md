# gp-connect-second-generation

![Build](https://github.com/NHSDigital/gp-connect-second-generation/workflows/Build/badge.svg?branch=master)

This is a specification for the *gp-connect-second-generation* API.
...
## Contributing
Contributions to this project are welcome from anyone, providing that they conform to the [guidelines for contribution](https://github.com/NHSDigital/gp-connect-second-generation/blob/master/CONTRIBUTING.md) and the [community code of conduct](https://github.com/NHSDigital/gp-connect-second-generation/blob/master/CODE_OF_CONDUCT.md).
...
Telling Apigee how to connect to your backend requires a *Target Server*, which you should call named `gp-connect-second-generation-target`.
